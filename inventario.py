        ...
        if opcion == "1":
            ...
            while True:
                ...
                if eleccion in inventario:
                    ...
                    print(f"\n===== Precio de '{datos["nombre"]}' cambiado con exito de {precio_anterior}$ a {datos["precio_unit"]}$ =====")
                    guardar_inventario(inventario)
        ...
        try:
            ...
            if eleccion in inventario:
                ...
                if opcion == "1":
                    ...
                    print(f"\n======= Nombre cambiado con exito a {inventario[eleccion]["nombre"]} =======")
                    guardar_inventario(inventario)
                    ...
                    guardar_inventario(inventario)
                    registrar_cambio(f"Cambio de minimo de producto #{eleccion} - nombre: {inventario[eleccion]["nombre"]} - nueva unidad de medida: {inventario[eleccion]["unidad_medida"]}")
                    break
                else:
    ...
    while True:
        try:
            ...
            if eleccion == 1:
                ...
                print("\nOpcion no valida escoja una de las opciones anteriores")
        except ValueError:
                    print("\nEscribe un caracter valido")